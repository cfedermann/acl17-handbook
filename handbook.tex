...
%\addcontentsline{toc}{chapter}{WiNLP: Women \& Underrepresented Minorities in Natural Language Processing}
...
%%%IGNORE\input{content/day1/day1}

\setdaydateyear{Tuesday}{August 1}{2017}
%%%IGNORE\input{content/day2/day2}

\setdaydateyear{Wednesday}{August 2}{2017}
%%%IGNORE\input{content/day3/day3}

%% Cultural event %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% \setdaydateyear{Tuesday}{August 1}{2017}
%%\addcontentsline{toc}{chapter}{Social Event: \daydate, 6:00pm}
